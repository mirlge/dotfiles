...
--hl.bind("mouse:272", hy3.focus_tab({ mouse = "require_hovered" }), { non_consuming = true })

-- Move window
hl.bind(mainMod .. " + SHIFT + H", hy3.move_window("l", { follow = true }))
hl.bind(mainMod .. " + SHIFT + J", hy3.move_window("d", { follow = true }))
hl.bind(mainMod .. " + SHIFT + K", hy3.move_window("u", { follow = true }))
hl.bind(mainMod .. " + SHIFT + L", hy3.move_window("r", { follow = true }))

-- Switch split layout
hl.bind(mainMod .. " + apostrophe", hy3.make_group("h"))
hl.bind(mainMod .. " + backslash", hy3.make_group("v"))
hl.bind(mainMod .. " + T", hy3.make_group("tab"))

-- Change split layout for active window
hl.bind(mainMod .. " + SHIFT + apostrophe", hy3.change_group("h"))
hl.bind(mainMod .. " + SHIFT + backslash", hy3.change_group("v"))
hl.bind(mainMod .. " + SHIFT + T", hy3.change_group("toggletab"))

-- Change focus (up/down)wards
hl.bind(mainMod .. " + period", hy3.change_focus("raise"))
hl.bind(mainMod .. " + comma", hy3.change_focus("lower"))
...
for i = 1, 9 do
  hl.bind(mainMod .. " + SHIFT + " .. i, hy3.move_to_workspace(i, { follow = true }))
end
hl.bind(mainMod .. " + SHIFT + 0", hy3.move_to_workspace("10", { follow = true }))
